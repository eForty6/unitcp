@php
    ...
    array_push($breadcrumb_array,collect(['is_last'=>false,'name'=>'مديرى النظام','link'=> lang_route('panel.users.all')]));
@endphp
...
@section('main')
    ...
    <div class="content">
        {!! Form::open(['id'=>'form','method'=>'POST','url'=>lang_route('panel.users.create'),'to'=>lang_route('panel.users.all')]) !!}
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-body">
                        <fieldset class="form-group">
                            <label>الأسم</label>
                            <input class="form-control"  type="text" name="name" placeholder="الرجاء إدخال العنوان"  value="" required>
                        </fieldset>
