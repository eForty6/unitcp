...
@section('main')
    ...
    <div class="pageheader">
        <h2><i class="fa fa-home"></i> Dashboard <span>   Templates / Contribute </span></h2>
    </div>
                    ...
                    <div class="tab-pane active" id="profile3">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                <div class="row">
                                    {!! Form::open(['id'=>'form','method' =>'PUT','url'=> lang_route('panel.settings.website') , 'to'=> lang_route('panel.template.contribute')]) !!}


                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" style="text-align: center">Contribute Title</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="contribute_title" placeholder="Enter Title" value="{{$constant->valueOf('contribute_title')}}" class="form-control" required/>
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" style="text-align: center">Contribute Title (Arabic) </label>
                                        <div class="col-sm-9">
                                            <input type="text" style="float: right" name="contribute_title_ar" placeholder="Enter Title  (Arabic)" value="{{$constant->valueOf('contribute_title_ar')}}" class="form-control" required/>
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" style="text-align: center">Contribute Text</label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" rows="6" name="contribute_txt"
                                                      required>{!! $constant->valueOf('contribute_txt') !!}</textarea>
                                        </div>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" style="text-align: center">Contribute Text (Arabic) </label>
                                        <div class="col-sm-9">
                                            <textarea class="form-control" style="float: right" rows="6" name="contribute_txt_ar"
                                                      required>{!! $constant->valueOf('contribute_txt_ar') !!}</textarea>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane " id="home3">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    @php
                                        $items = \App\Section::contribute()->get();
                                    @endphp
        ...
        <div class="modal-dialog modal-photo-viewer">
            ...
            <div style="height: auto" class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Contribute Template </h4>
                </div>
                <div class="modal-body">
                    ...
                    <div id="modal_body" class="row">
                        ...
                        <input type="hidden" name="type" value="contribute">
