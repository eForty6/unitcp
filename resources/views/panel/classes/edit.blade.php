@php
    ...
    array_push($breadcrumb_array,collect(['is_last'=>false,'name'=>'الفرق الدراسيه','link'=> lang_route('panel.classes.all')]));
@endphp
...
@section('main')
    ...
    <div class="content">
        {!! Form::open(['id'=>'form','method'=>'PUT','url'=>lang_route('panel.classes.edit',['id'=>$classes->id]),'to'=>lang_route('panel.classes.all')]) !!}
