...
return [
    ...
    */
    ...
    |
    */
//{{--SELECT `id`, `user_id`, `category_id`, `status`, `type`, `name`, `brief_description`,--}}
//{{--`description`, `photo`, `video`, `trainee_requirements`, --}}
//{{--`accomplishments`, `price`, `is_public`, `created_at`, `updated_at`, `deleted_at` FROM `courses` WHERE 1--}}
